function Modalities() {
    return ( 
        <div className="pb-20 w-full">
                ...
                <p className="w-ful 2xl:text-[24px] xl:text-[24px] lg:text-[24px] md:text-[24px] text-[18px] text-white font-body mt-6">
                    Palestras e workshops para capacitar sua equipe e aplicar estratégias de Loyalty</p>
            </div>
            
            <div className="mt-10 flex flex-col items-center justify-center gap-6">
                
                <div className="relative 2xl:w-[1155px] xl:w-[1155px] lg:w-[1155px] md:w-[350px] w-[300px] h-[339px] rounded-lg overflow-hidden 
  ...
  <div className="absolute inset-0 bg-black opacity-50"></div>
                    <div className="bg-[url('/images/palestra1.png')] bg-cover bg-center no-repeat w-full h-full 2xl:p-10 xl:p-10 lg:p-10 md:p-10 p-5">
                        ...
                        <p className="font-body text-white text-[18px] font-normal absolute mt-20  w-[90%]">
...
conhecimento de forma clara e objetiva, para provocar reflexões e despertar o interesse por novas abordagens no relacionamento com clientes.
                ...
                <div className="relative 2xl:w-[1155px] xl:w-[1155px] lg:w-[1155px] md:w-[350px] w-[300px] h-[339px] rounded-lg overflow-hidden  transition-transform duration-300 hover:scale-105">
  <div className="absolute inset-0 bg-black opacity-50"></div>
