...
function Form() {
    ...
    return ( 
        <div className="pb-20">
                ...
                <p className="w-ful 2xl:text-[24px] xl:text-[24px] lg:text-[24px] md:text-[24px] text-[18px] text-white font-body mt-6">Entre em contato e saiba como a Indico Academy pode transformar sua empresa</p>
        </div>
